" File:         after/plugin/lightline.vim
...
" Create help menu.
ANoremenu &Help.&Plugins 'Lightline: A light and configurable statusline/tabline for Vim' ''
						\ :help lightline<CR> 

" Initialize so dynamic colorschemes don't trigger errors
call lightline#init()
